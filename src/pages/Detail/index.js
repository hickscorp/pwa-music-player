          ...
          <div className="detail__controls">
            ...
            <div className="detail__buttons">
              <IconButton label="repeat song" tabEnabled={this.props.active} className={`icon-button ${this.props.repeat ? 'icon-button--high-light': ''}`} onClick={this.props.onRepeatClick} icon={<RepeatButton className="icon icon--back" width={16} />} />
                <button name="previous song" tabIndex={this.props.active ? "0" : "-1"} className="prev-button" onClick={this.props.onPlayPrev}>
                  <PlayButton width={16} />
                </button>
              ...
              <button name="next song button" tabIndex={this.props.active ? "0" : "-1"} className="next-button" onClick={this.props.onPlayNext}>
                <PlayButton width={16} />
              </button>
